namespace FS.Membership.Database.Contexts
{
    public class FSContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder builder)
        {
            ...
            builder.Entity<SimilarFilms>().HasData(
                new SimilarFilms { ParentFilmId = 1, SimilarFilmId = 5 },
                new SimilarFilms { ParentFilmId = 2, SimilarFilmId = 5 },
                new SimilarFilms { ParentFilmId = 2, SimilarFilmId = 7 },
                new SimilarFilms { ParentFilmId = 3, SimilarFilmId = 11 },
                new SimilarFilms { ParentFilmId = 4, SimilarFilmId = 6 },
                new SimilarFilms { ParentFilmId = 4, SimilarFilmId = 8 },
                new SimilarFilms { ParentFilmId = 5, SimilarFilmId = 1 },
                new SimilarFilms { ParentFilmId = 5, SimilarFilmId = 2 },
                new SimilarFilms { ParentFilmId = 5, SimilarFilmId = 9 },
                new SimilarFilms { ParentFilmId = 6, SimilarFilmId = 4 },
                new SimilarFilms { ParentFilmId = 7, SimilarFilmId = 8 },
                new SimilarFilms { ParentFilmId = 7, SimilarFilmId = 2 },
                new SimilarFilms { ParentFilmId = 8, SimilarFilmId = 7 },
                new SimilarFilms { ParentFilmId = 8, SimilarFilmId = 4 },
                new SimilarFilms { ParentFilmId = 9, SimilarFilmId = 5 },
                new SimilarFilms { ParentFilmId = 11, SimilarFilmId = 3 });
